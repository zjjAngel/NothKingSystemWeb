 ...
 * 需求管理
 */
export const requireAddRequire = "http://192.168.0.108:8088/require/addRequire"  // 添加接口

export const requireUpdateRequire = "http://192.168.0.108:8088/require/updateRequire" // 更新操作

export const requireSelectRequire = "http://192.168.0.108:8088/api/NothKingSystem/require/selectRequire" // 查询数据操作

export const requireDeleteRequire = "http://192.168.0.108:8088/require/deleteRequire" // 删除需求客户信息
 ...
 */
 ...
 export const userList = "http://192.168.0.108:8088/api/NothKingSystem/SysUsrMnger/querySelectUsr" //查询用户下拉框
 export const roleIdList = "http://192.168.0.108:8088/api/NothKingSystem/SysUsrMnger/querySelectRole" //查询角色下拉框
 export const delUser = "http://192.168.0.108:8088/api/NothKingSystem/SysUsrMnger/deleteUsrInfo" //删除用户
 export const editUser = "http://192.168.0.108:8088/api/NothKingSystem/SysUsrMnger/updateUsrInfo" //修改用户
