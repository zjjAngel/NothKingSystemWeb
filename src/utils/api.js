 ...
 * 客户管理
 */
export const custQuery = "http://192.168.0.115:8067/cust/query" // 客户查询
export const custAdd = "http://192.168.0.115:8067/cust/add" // 客户添加
export const custUpdate = "http://192.168.0.115:8067/cust/update" // 客户编辑
export const custDel = "http://192.168.0.115:8067/cust/del" // 客户编辑

/**
 * 项目管理
 */
export const projectQuery = "http://192.168.0.115:8067/project/query" // 项目查询
export const projectAdd = "http://192.168.0.115:8067/project/add" // 项目添加
export const projectUpdate = "http://192.168.0.115:8067/project/upd" // 项目编辑
export const projectDel = "http://192.168.0.115:8067/project/del" // 项目编辑


/**
 * 需求管理
 */
export const requireAddRequire = "http://192.168.0.115:8067/require/addRequire"  // 添加接口

export const requireUpdateRequire = "http://192.168.0.115:8067/require/updateRequire" // 更新操作

export const requireSelectRequire = "http://192.168.0.115:8067/api/NothKingSystem/require/selectRequire" // 查询数据操作

export const requireDeleteRequire = "http://192.168.0.115:8067/require/deleteRequire" // 删除需求客户信息

export const requireSelectRequireCust = "http://192.168.0.115:8067/require/selectRequireCust" // 查询需求客户信息(头部枚举值)

export const requireSelectRequireByCustName = "http://192.168.0.115:8067/require/selectRequireByCustName" // 根据客户查询需求项目信息(头部枚举值)
export const RequireSearch = "http://192.168.0.115:8067/require/selectRequire" //需求管理的搜索
...
export const MenuAdd ="http://192.168.0.115:8067/api/NothKingSystem/menu/insertMenuMngerInfo" //菜单添加
